...
import { nomContainer, result, btnHasard, btnAfficher, nombreParticipants, btnReset } from "./dom";
...
export class App {
  ...
  private updateButtons(): void {
    ...
    btnReset.disabled = this.participants.length === 0;
    nombreParticipants.textContent = this.participants.length === 0 ? '' : this.participants.length.toString();
  }
